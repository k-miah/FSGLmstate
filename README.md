...
[![DOI](https://img.shields.io/badge/DOI-10.1002%2Fbimj.70087-blue)](https://doi.org/10.1002/bimj.70087)

`FSGLmstate` is an R package that performs variable selection via fused sparse-group lasso (FSGL) penalized multi-state models [(Miah et al., 2025)](https://doi.org/10.1002/bimj.70087).
